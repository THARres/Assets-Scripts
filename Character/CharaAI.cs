public class CharaAI : UnityEngine.MonoBehaviour {
	...
	private CharaInputAI gate = null;
	...
	private void UpdateMovement() {
		...
		default:
			...
			gate.SetValue("left0" , false);
			gate.SetValue("down0" , false);
			gate.SetValue("right0", false);
			break;
		}
	}
 ...
 */
  ...
  */
	public void SetDefaultValue() {
		gate = GetComponent<CharaInputAI>();
	}
